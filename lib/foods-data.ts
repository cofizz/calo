...
export const FOODS: LocalFood[] = [
  // --- Eggs & proteins ---
  { display: "Egg", keywords: ["egg", "eggs"], per100: { cal: 143, p: 12.6, c: 0.7, f: 9.5 }, portionGrams: 50 },
  { display: "Egg white", keywords: ["egg white", "egg whites"], per100: { cal: 52, p: 11, c: 0.7, f: 0.2 }, portionGrams: 33 },
  { display: "Chicken breast", keywords: ["chicken breast", "chicken"], per100: { cal: 165, p: 31, c: 0, f: 3.6 } },
  { display: "Chicken thigh", keywords: ["chicken thigh"], per100: { cal: 209, p: 26, c: 0, f: 10.9 } },
  { display: "Ground beef", keywords: ["ground beef", "minced beef", "beef mince", "mince"], per100: { cal: 250, p: 26, c: 0, f: 15 } },
  { display: "Steak", keywords: ["steak", "beef"], per100: { cal: 271, p: 25, c: 0, f: 19 } },
  { display: "Pork chop", keywords: ["pork chop", "pork"], per100: { cal: 231, p: 26, c: 0, f: 14 } },
  { display: "Bacon", keywords: ["bacon"], per100: { cal: 541, p: 37, c: 1.4, f: 42 }, portionGrams: 8 },
  { display: "Salmon", keywords: ["salmon"], per100: { cal: 208, p: 20, c: 0, f: 13 } },
  { display: "Tuna (canned)", keywords: ["tuna"], per100: { cal: 116, p: 26, c: 0, f: 1 } },
  { display: "Shrimp", keywords: ["shrimp", "prawns", "prawn"], per100: { cal: 99, p: 24, c: 0.2, f: 0.3 } },
  { display: "Turkey breast", keywords: ["turkey breast", "turkey"], per100: { cal: 135, p: 30, c: 0, f: 1 } },
  { display: "Ham", keywords: ["ham"], per100: { cal: 145, p: 18, c: 1.5, f: 7 }, portionGrams: 28 },
  { display: "Tofu", keywords: ["tofu"], per100: { cal: 76, p: 8, c: 1.9, f: 4.8 } },

  // --- Grains & carbs ---
  { display: "White rice (cooked)", keywords: ["white rice", "rice"], per100: { cal: 130, p: 2.7, c: 28, f: 0.3 } },
  { display: "Brown rice (cooked)", keywords: ["brown rice"], per100: { cal: 123, p: 2.7, c: 26, f: 1 } },
  { display: "Pasta (cooked)", keywords: ["pasta", "spaghetti", "noodles"], per100: { cal: 158, p: 6, c: 31, f: 0.9 } },
  { display: "White bread", keywords: ["white bread", "bread"], per100: { cal: 265, p: 9, c: 49, f: 3.2 }, portionGrams: 28 },
  { display: "Whole wheat bread", keywords: ["whole wheat bread", "wholewheat bread", "brown bread", "wheat bread"], per100: { cal: 247, p: 13, c: 41, f: 3.4 }, portionGrams: 28 },
  { display: "Oats (dry)", keywords: ["oats", "oatmeal", "porridge"], per100: { cal: 389, p: 17, c: 66, f: 7 }, portionGrams: 40 },
  { display: "Potato", keywords: ["potato", "potatoes"], per100: { cal: 87, p: 1.9, c: 20, f: 0.1 }, portionGrams: 150 },
  { display: "Sweet potato", keywords: ["sweet potato"], per100: { cal: 90, p: 2, c: 21, f: 0.1 }, portionGrams: 130 },
  ...
  // --- Fruits ---
  { display: "Banana", keywords: ["banana", "bananas"], per100: { cal: 89, p: 1.1, c: 23, f: 0.3 }, portionGrams: 118 },
  { display: "Apple", keywords: ["apple", "apples"], per100: { cal: 52, p: 0.3, c: 14, f: 0.2 }, portionGrams: 182 },
  { display: "Orange", keywords: ["orange", "oranges"], per100: { cal: 47, p: 0.9, c: 12, f: 0.1 }, portionGrams: 131 },
  { display: "Strawberries", keywords: ["strawberries", "strawberry"], per100: { cal: 32, p: 0.7, c: 7.7, f: 0.3 } },
  { display: "Blueberries", keywords: ["blueberries", "blueberry"], per100: { cal: 57, p: 0.7, c: 14, f: 0.3 } },
  { display: "Grapes", keywords: ["grapes", "grape"], per100: { cal: 69, p: 0.7, c: 18, f: 0.2 } },
  { display: "Avocado", keywords: ["avocado", "avocados"], per100: { cal: 160, p: 2, c: 9, f: 15 }, portionGrams: 150 },
  { display: "Mango", keywords: ["mango", "mangoes"], per100: { cal: 60, p: 0.8, c: 15, f: 0.4 }, portionGrams: 200 },

  // --- Dairy ---
  { display: "Whole milk", keywords: ["whole milk", "milk"], per100: { cal: 61, p: 3.2, c: 4.8, f: 3.3 }, portionGrams: 244 },
  { display: "Skim milk", keywords: ["skim milk", "skimmed milk"], per100: { cal: 34, p: 3.4, c: 5, f: 0.1 }, portionGrams: 244 },
  { display: "Greek yogurt", keywords: ["greek yogurt", "greek yoghurt"], per100: { cal: 59, p: 10, c: 3.6, f: 0.4 }, portionGrams: 170 },
  { display: "Yogurt", keywords: ["yogurt", "yoghurt"], per100: { cal: 61, p: 3.5, c: 4.7, f: 3.3 }, portionGrams: 170 },
  { display: "Cheddar cheese", keywords: ["cheddar", "cheese"], per100: { cal: 403, p: 25, c: 1.3, f: 33 }, portionGrams: 28 },
  { display: "Mozzarella", keywords: ["mozzarella"], per100: { cal: 280, p: 28, c: 3.1, f: 17 }, portionGrams: 28 },
  { display: "Cottage cheese", keywords: ["cottage cheese"], per100: { cal: 98, p: 11, c: 3.4, f: 4.3 } },
  { display: "Butter", keywords: ["butter"], per100: { cal: 717, p: 0.9, c: 0.1, f: 81 }, portionGrams: 14 },

  // --- Nuts & fats ---
  { display: "Almonds", keywords: ["almonds", "almond"], per100: { cal: 579, p: 21, c: 22, f: 50 }, portionGrams: 28 },
  { display: "Peanuts", keywords: ["peanuts", "peanut"], per100: { cal: 567, p: 26, c: 16, f: 49 }, portionGrams: 28 },
  { display: "Peanut butter", keywords: ["peanut butter"], per100: { cal: 588, p: 25, c: 20, f: 50 }, portionGrams: 16 },
  { display: "Walnuts", keywords: ["walnuts", "walnut"], per100: { cal: 654, p: 15, c: 14, f: 65 }, portionGrams: 28 },
  { display: "Cashews", keywords: ["cashews", "cashew"], per100: { cal: 553, p: 18, c: 30, f: 44 }, portionGrams: 28 },
  { display: "Olive oil", keywords: ["olive oil", "oil"], per100: { cal: 884, p: 0, c: 0, f: 100 }, portionGrams: 14 },

  // --- Vegetables ---
  { display: "Broccoli", keywords: ["broccoli"], per100: { cal: 35, p: 2.4, c: 7, f: 0.4 } },
  { display: "Spinach", keywords: ["spinach"], per100: { cal: 23, p: 2.9, c: 3.6, f: 0.4 } },
  { display: "Carrot", keywords: ["carrot", "carrots"], per100: { cal: 41, p: 0.9, c: 10, f: 0.2 }, portionGrams: 61 },
  { display: "Tomato", keywords: ["tomato", "tomatoes"], per100: { cal: 18, p: 0.9, c: 3.9, f: 0.2 }, portionGrams: 123 },
  { display: "Cucumber", keywords: ["cucumber"], per100: { cal: 15, p: 0.7, c: 3.6, f: 0.1 } },
  { display: "Onion", keywords: ["onion", "onions"], per100: { cal: 40, p: 1.1, c: 9, f: 0.1 } },
  { display: "Bell pepper", keywords: ["bell pepper", "pepper", "capsicum"], per100: { cal: 31, p: 1, c: 6, f: 0.3 }, portionGrams: 119 },
  { display: "Corn", keywords: ["corn", "sweetcorn"], per100: { cal: 96, p: 3.4, c: 21, f: 1.5 } },

  // --- Meals, snacks & drinks ---
  { display: "Pizza", keywords: ["pizza"], per100: { cal: 266, p: 11, c: 33, f: 10 }, portionGrams: 107 },
  { display: "Hamburger", keywords: ["hamburger", "burger", "cheeseburger"], per100: { cal: 295, p: 17, c: 24, f: 14 }, portionGrams: 150 },
  { display: "French fries", keywords: ["french fries", "fries", "chips"], per100: { cal: 312, p: 3.4, c: 41, f: 15 }, portionGrams: 117 },
  { display: "Milk chocolate", keywords: ["chocolate", "milk chocolate"], per100: { cal: 535, p: 7.6, c: 59, f: 30 }, portionGrams: 45 },
  { display: "Ice cream", keywords: ["ice cream", "icecream"], per100: { cal: 207, p: 3.5, c: 24, f: 11 }, portionGrams: 66 },
  { display: "Whey protein", keywords: ["whey", "protein powder", "protein shake", "whey protein"], per100: { cal: 400, p: 80, c: 8, f: 7 }, portionGrams: 30 },
  { display: "Orange juice", keywords: ["orange juice", "oj"], per100: { cal: 45, p: 0.7, c: 10, f: 0.2 }, portionGrams: 248 },
  { display: "Coca-Cola", keywords: ["coke", "cola", "coca-cola", "soda"], per100: { cal: 42, p: 0, c: 11, f: 0 }, portionGrams: 330 },
  { display: "Beer", keywords: ["beer"], per100: { cal: 43, p: 0.5, c: 3.6, f: 0 }, portionGrams: 355 },
  { display: "Coffee (black)", keywords: ["coffee", "espresso"], per100: { cal: 1, p: 0.1, c: 0, f: 0 }, portionGrams: 240 },
  ...
  { display: "Sausage", keywords: ["sausage", "sausages"], per100: { cal: 301, p: 12, c: 1.5, f: 27 }, portionGrams: 75 },
  { display: "Hot dog", keywords: ["hot dog", "hotdog", "frankfurter"], per100: { cal: 290, p: 10, c: 4, f: 26 }, portionGrams: 50 },
  ...
  { display: "Lentils (cooked)", keywords: ["lentils", "lentil"], per100: { cal: 116, p: 9, c: 20, f: 0.4 } },
  { display: "Chickpeas (cooked)", keywords: ["chickpeas", "chickpea", "garbanzo"], per100: { cal: 164, p: 9, c: 27, f: 2.6 } },
  { display: "Black beans (cooked)", keywords: ["black beans", "black bean"], per100: { cal: 132, p: 9, c: 24, f: 0.5 } },
  { display: "Kidney beans (cooked)", keywords: ["kidney beans", "kidney bean", "beans"], per100: { cal: 127, p: 9, c: 23, f: 0.5 } },
  ...
  { display: "Pancake", keywords: ["pancake", "pancakes"], per100: { cal: 227, p: 6, c: 28, f: 9 }, portionGrams: 38 },
  ...
  // --- More vegetables ---
  { display: "Lettuce", keywords: ["lettuce"], per100: { cal: 15, p: 1.4, c: 2.9, f: 0.2 } },
  { display: "Cauliflower", keywords: ["cauliflower"], per100: { cal: 25, p: 1.9, c: 5, f: 0.3 } },
  { display: "Mushroom", keywords: ["mushroom", "mushrooms"], per100: { cal: 22, p: 3.1, c: 3.3, f: 0.3 } },
  ...
  { display: "Cabbage", keywords: ["cabbage"], per100: { cal: 25, p: 1.3, c: 6, f: 0.1 } },
  ...
  { display: "Garlic", keywords: ["garlic"], per100: { cal: 149, p: 6.4, c: 33, f: 0.5 }, portionGrams: 3 },
  ...
  { display: "Cookie", keywords: ["cookie", "cookies"], per100: { cal: 488, p: 5, c: 64, f: 24 }, portionGrams: 16 },
  { display: "Brownie", keywords: ["brownie", "brownies"], per100: { cal: 466, p: 6, c: 50, f: 28 }, portionGrams: 56 },
  { display: "Cake", keywords: ["cake"], per100: { cal: 371, p: 5, c: 50, f: 17 }, portionGrams: 80 },
  ...
  { display: "Honey", keywords: ["honey"], per100: { cal: 304, p: 0.3, c: 82, f: 0 }, portionGrams: 21 },
  ...
  { display: "Sugar", keywords: ["sugar"], per100: { cal: 387, p: 0, c: 100, f: 0 }, portionGrams: 4 },
  ...
  // --- More drinks ---
  { display: "Water", keywords: ["water"], per100: { cal: 0, p: 0, c: 0, f: 0 }, portionGrams: 240 },
  { display: "Tea", keywords: ["tea"], per100: { cal: 1, p: 0, c: 0.3, f: 0 }, portionGrams: 240 },
  ...
  { display: "Wine", keywords: ["wine"], per100: { cal: 83, p: 0.1, c: 2.6, f: 0 }, portionGrams: 150 },
